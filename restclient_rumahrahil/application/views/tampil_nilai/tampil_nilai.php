...
<head>
    ...
    <style>
        .card {
            box-shadow: 0 4px 4px 0 rgba(169, 169, 169, 2);
            transition: 0.3s;
        }
                                ...
                                <div class="row p-3">
                                    <div class="card-body m-auto">
                                        <div class="chart-wrapper text-center">
                                            ...
                                            <hr>
                                            <br>
                                            <span style="color: yellow; text-shadow: 0 196px 196px 196px"><i class="fas fa-medal fa-10x"></i></span>
                                            <h1>
                                                <p style="line-height: 2em;">Anda telah menyelesaikan ujian dengan nilai :<p> 75</p>
                                                <p>Nama Subtema 1</p>
                                                <p>Tema 1</p>
                                            </h1>
                                            <br><br>
                                            <a href="" class="btn btn-outline-success" data-toggle="modal" data-target="#Edit">Simpan & CLose</a>
                                            <br><br>
                                        </div>
                                        </div>
                                    </div><!-- chart-wrapper -->
